...
export function ProductSelector({ 
  ...
  const buildWhatsAppLink = () => {
    ...
    const colorName = displayColor;
    const price = currentPrice.toLocaleString();
    
    const message = `Hello Sahu Mobiles, I am interested in negotiating the price for this product:\n\n` +
      `📱 *Product:* ${productName}\n` +
      `⚙️ *Specs:* ${variantName}\n` +
      `🎨 *Color:* ${colorName}\n` +
      `💰 *Listed Price:* ₹${price}\n\n` +
      `Can you offer any discount or deal for this item? Thanks!`;
    ...
    return (
      <div className={styles.stickyContainer}>
        ...
        <div className={styles.stickyButtons}>
          <AddToCartButton product={productForCart} className={styles.stickyCartBtn} />
          <a 
            href={whatsappLink} 
            target="_blank" 
            rel="noopener noreferrer" 
            className={styles.whatsappBargainBtnSticky}
          >
            Bargain 💬
          </a>
        </div>
    ...
    <div className={styles.container}>
      ...
      <div className={styles.actions}>
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className={styles.whatsappBargainBtn}
        >
