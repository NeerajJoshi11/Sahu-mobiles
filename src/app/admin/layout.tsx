    ...
    <div className={styles.adminWrapper}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          ...
          <Link href="/admin/products" className={`${styles.navLink} ${pathname === "/admin/products" ? styles.active : ""}`}>
          ...
          <Link href="/admin/users" className={`${styles.navLink} ${pathname === "/admin/users" ? styles.active : ""}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            Customers
          </Link>
          <Link href="/admin/coupons" className={`${styles.navLink} ${pathname === "/admin/coupons" ? styles.active : ""}`}>
          ...
          <Link href="/admin/express" className={`${styles.navLink} ${pathname === "/admin/express" ? styles.active : ""}`}>
